        ...
        <main className="flex h-[780px] w-[360px] flex-col overflow-hidden rounded-3xl bg-slate-100">
          {step === 1 ? (
            ...
            <>
              ...
              <section className="px-4 py-2 text-sm text-slate-600">
              ...
              <nav className="mt-auto grid grid-cols-5 gap-1 border-t border-slate-200 bg-white px-2 py-2 text-xs text-slate-500">
                <button className="py-1">Home</button>
                <button className="py-1">Discover</button>
                <button className="py-0 text-2xl leading-none text-emerald-600">＋</button>
