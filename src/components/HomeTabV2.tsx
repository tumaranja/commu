...
function HeroBanner() {
  return (
    <div className="mb-4 rounded-2xl bg-gradient-to-br from-emerald-50 to-teal-50 p-5">
      ...
      <button
        type="button"
        className="rounded-xl bg-emerald-500 px-5 py-2.5 text-sm font-semibold text-white shadow-sm"
      >
        Offer help
      </button>
      <button
...
function InvitePrompt() {
  return (
    <div className="mb-4 flex items-center gap-2.5 rounded-xl bg-slate-50 px-3.5 py-2.5">
      ...
      <button
        type="button"
        className="shrink-0 rounded-lg bg-white px-3 py-1.5 text-xs font-semibold text-slate-600 shadow-sm ring-1 ring-slate-200"
      >
        Share
      </button>
    </div>
